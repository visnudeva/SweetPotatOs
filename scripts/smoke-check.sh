...
check_grep '%h/\.config/swirl/scripts/nwg-displays\.sh' "${ISO}/etc/skel/.local/share/applications/nwg-displays.desktop" "skel Displays Exec uses %h path"
...
check_grep 'maximize/minimize window' "${ISO}/etc/skel/.config/swirl/scripts/tips.sh" "tips wording for Mod+m"
check_grep 'web browser' "${ISO}/etc/skel/.config/swirl/scripts/tips.sh" "tips wording for Mod+w"
