...
# Optional:
#   SF_RELEASE=2026.09_Second_Harvest ./sourceforge/upload.sh   # FRS folder name
#   ISO_NAME=Sweetpotatos_2026.09_Second_Harvest.iso ./sourceforge/upload.sh
set -euo pipefail

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
SF_USER="${SF_USER:-}"
SF_PROJECT="${SF_PROJECT:-sweetpotatos}"
SF_RELEASE="${SF_RELEASE:-2026.09_Second_Harvest}"
ISO_NAME="${ISO_NAME:-Sweetpotatos_2026.09_Second_Harvest.iso}"
